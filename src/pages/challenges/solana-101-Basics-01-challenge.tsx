...
type Solana101Basics01ChallengePageProps = {
    user: User;
};

const Solana101Basics01ChallengePage: NextPage<
    Solana101Basics01ChallengePageProps
> = ({ user }) => {
    ...
    const [title, setTitle] = useState('Solana 101: Basics-01');
    ...
    const [challengeID, setChallengeID] = useState('221007061');
...
export default Solana101Basics01ChallengePage;
