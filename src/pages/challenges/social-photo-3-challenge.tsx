...
type SocialPhotoThreeChallengePageProps = {
    user: User;
};

const SocialPhotoThreeChallenge: NextPage<
    SocialPhotoThreeChallengePageProps
> = ({ user }) => {
    ...
    const [challengeID, setChallengeID] = useState('221004044');
...
export default SocialPhotoThreeChallenge;
