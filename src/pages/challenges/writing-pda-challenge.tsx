...
type WritingPDAsChallengePageProps = {
    user: User;
};

const WritingPDAsChallengePage: NextPage<WritingPDAsChallengePageProps> = ({
    user,
}) => {
    ...
    const [title, setTitle] = useState('Writing PDAs');
    const [hunter, setHunter] = useState('');

    const [answerOne, setSubmitProgramID] = useState('');
    const [answerTwo, setSubmitTransactionID] = useState('');
    const [answerThree, setSubmitAccountAddress] = useState('');
    const [answerFour, setSubmitTime] = useState('');
    const [submission, setSubmission] = useState('');
    const [submitUniversity, setSubmitUniversity] = useState('');
    const [isLoading, setIsLoading] = useState(false);
    const [challengeID, setChallengeID] = useState('221007107');
...
3. The address of your Lookup Table.
4. Time it took to successfully send this transaction.
        ...
        () => [
            {
                content: (
                    <div>
                        ...
                        <input
                            className="w-full border-none bg-transparent py-5 outline-none"
                            value="3. Enter the address of the PDA account you created with custom data:"
                        />
                        <Card className="h-fit w-full p-5 transition-all duration-300 focus-within:border-3 focus-within:border-primary">
                            <input
                                className="w-full items-center bg-transparent outline-none"
                        ...
                        <input
                            className="w-full border-none bg-transparent py-5 outline-none"
                            value="4. How long did it take you to deploy this program without error?"
                        />
                        <Card className="h-fit w-full p-5 transition-all duration-300 focus-within:border-3 focus-within:border-primary">
                            <input
                                className="w-full items-center bg-transparent outline-none"
...
3. The address of your created PDA account.
${answerThree}

4. Time it took to successfully deploy this program.
${answerFour}
...
export default WritingPDAsChallengePage;
