...
type SocialPhotoBombOneChallengePageProps = {
    user: User;
};

const SocialPhotoBombOneChallenge: NextPage<
    SocialPhotoBombOneChallengePageProps
> = ({ user }) => {
    ...
    const [challengeID, setChallengeID] = useState('221005063');
...
- Enter the link to your twitter post with you photo Bombing Dana!
...
export default SocialPhotoBombOneChallenge;
