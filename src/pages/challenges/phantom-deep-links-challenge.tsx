...
type PhantomDeepLinksChallengePageProps = {
    user: User;
};

const PhantomDeepLinksChallengePage: NextPage<
    PhantomDeepLinksChallengePageProps
> = ({ user }) => {
    ...
    const [title, setTitle] = useState('Phantom Deeplinks: 101');
    ...
    const [challengeID, setChallengeID] = useState('221007051');
...
Let's get to it ${session?.user?.name}!
...
1. Answer: What do deeplinks also make it easy for users to do?
2. Enter the base url for: What is the base url.
3. Enter the payload used to Sign and Send a Transaction.
4. Enter the feature that allows users to open web apps within Phantom's in-app browser.
                ...
                content: (
                    <div>
                        ...
                        <input
                            ...
                            value="1. What do deeplinks also make it easy for users to do?"
                        />
                        ...
                        <input
                            className="w-full border-none bg-transparent py-5 outline-none"
                            value="2. What is the base url that phantom uses to connect?"
                        />
                        <Card className="h-fit w-full p-5 transition-all duration-300 focus-within:border-3 focus-within:border-primary">
                            <input
                                className="w-full items-center bg-transparent outline-none"
                        ...
                        <input
                            className="w-full border-none bg-transparent py-5 outline-none"
                            value="3. What is the payload to Sign and Send a Transaction?"
                        />
                        <Card className="h-fit w-full p-5 transition-all duration-300 focus-within:border-3 focus-within:border-primary">
                            <textarea
                                className="w-full items-center bg-transparent outline-none"
                        ...
                        <input
                            className="w-full border-none bg-transparent py-5 outline-none"
                            value="4. How can users open web apps within Phantom's in-app browser, via what?"
                        />
                        <Card className="h-fit w-full p-5 transition-all duration-300 focus-within:border-3 focus-within:border-primary">
                            <input
                                className="w-full items-center bg-transparent outline-none"
...
1. What do deeplinks also make it easy for users to do?
${answerOne}

2. What is the base url that phantom uses to connect?"
${answerTwo}

3. What is the payload to Sign and Send a Transaction?
${answerThree}

4. How can users open web apps within Phantom's in-app browser, via what?
${answerFour}
...
export default PhantomDeepLinksChallengePage;
