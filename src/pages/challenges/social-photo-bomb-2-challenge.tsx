...
type SocialPhotoBombTwoChallengePageProps = {
    user: User;
};

const SocialPhotoBombTwoChallenge: NextPage<
    SocialPhotoBombTwoChallengePageProps
> = ({ user }) => {
    ...
    const [challengeID, setChallengeID] = useState('221005064');
...
export default SocialPhotoBombTwoChallenge;
