...
type SocialPhotoBombThreeChallengePageProps = {
    user: User;
};

const SocialPhotoBombThreeChallenge: NextPage<
    SocialPhotoBombThreeChallengePageProps
> = ({ user }) => {
    ...
    const [challengeID, setChallengeID] = useState('221005065');
...
- Enter the link to your twitter post with you and Buffalo Joe!
- Follow Buffalo Joe for more info on twitter!
...
export default SocialPhotoBombThreeChallenge;
