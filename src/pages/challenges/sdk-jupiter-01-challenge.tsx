...
type SDKJupiter01ChallengePageProps = {
    user: User;
};

const SDKJupiter01ChallengePage: NextPage<SDKJupiter01ChallengePageProps> = ({
    user,
}) => {
    ...
    const [title, setTitle] = useState('Jupiter SDK Challenge');
    ...
    const [challengeID, setChallengeID] = useState('221009118');
...
1. A link to your github Jupiter SDK implementation
                ...
                content: (
                    <div>
                        ...
                        <input
                            ...
                            value="1. A link to your github Jupiter SDK implementation"
                        />
...
1. Github Link to Jupiter SDK Example.
${answerOne}
...
export default SDKJupiter01ChallengePage;
